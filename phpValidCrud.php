  ...
  if($result){
    ...
    $mobile = $_POST["mobile"];
        ...
        if (!preg_match ($pattern, $email) ){  
            ...
            if ( $length != 10) {  
                echo '<script type ="text/JavaScript">';  
                echo 'alert("mobile number is not valid !!!! ")';  
                echo '</script>';  
            } else { 
...
<body>
  ...
  <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="/phpcrud/phpValidCrud.php" method="POST">
  ...
  <div class="container my-4">
        <h2>Contact Form</h2>
        <form class="row g-3" action="/phpcrud/phpValidCrud.php" method="post" id="myForm" name = "myForm" novalidate>
            <div class="col-12">
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to delete this note!")) {
          console.log("yes");
          window.location = `/phpcrud/phpValidCrud.php?delete=${sno}`;
